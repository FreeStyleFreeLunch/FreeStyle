...
class StableDiffusionXLPipeline(DiffusionPipeline, FromSingleFileMixin):
    ...
    def __call__(
        ...
        """ 
        print("****"*100)
        print("prompt:",prompt_embeds_tmp.shape)
        print("Nullprompt:",Nullprompt_embeds.shape)
        print("r:",torch.sum(prompt_embeds-Nullprompt_embeds))
        print("****"*100)
        print("****"*100)
        print("negative_prompt_embeds:",negative_prompt_embeds)
        print("Nullnegative_prompt_embeds:",Nullnegative_prompt_embeds)
        print("r:",torch.sum(negative_prompt_embeds-Nullnegative_prompt_embeds))
        print("****"*100)
        print("****"*100)
        print("pooled_prompt_embeds:",pooled_prompt_embeds)
        print("Nullpooled_prompt_embeds:",Nullpooled_prompt_embeds)
        print("pooled_prompt_embeds.shape:",pooled_prompt_embeds.shape)
        print("Nullpooled_prompt_embeds.shape",Nullpooled_prompt_embeds.shape)
        print("****"*100)
        print("****"*100)
        print("negative_pooled_prompt_embeds:",negative_pooled_prompt_embeds)
        print("Nullnegative_pooled_prompt_embeds:",Nullnegative_pooled_prompt_embeds)
        print("r:",torch.sum(negative_pooled_prompt_embeds-Nullnegative_pooled_prompt_embeds))
        print("****"*100)
        sys.exit()
        """
        """
        print("prompt:",prompt_embeds)
        print("negative_prompt_embeds:",negative_prompt_embeds)
        print("pooled_prompt_embeds:",pooled_prompt_embeds)
        print("negative_pooled_prompt_embeds:",negative_pooled_prompt_embeds)
        print("--------------------------------------------------------------------------------------------------")
        print("Nullprompt:",Nullprompt_embeds.shape)
        print("Nullpooled_prompt:",Nullnegative_prompt_embeds.shape)
        print("Nullnegative_prompt_embeds:",Nullpooled_prompt_embeds.shape)
        print("Nullnegative_pooled_prompt_embeds:",Nullnegative_pooled_prompt_embeds.shape)
        """
        # 4. Prepare timesteps
        ...
        #code added
        latents = self.prepare_pil2latent(self.refimg_f,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if self.refimg!=None:
                    ...
                    #print("text embedding: ",torch.nonzero(prompt_embeds-Nullprompt_embeds))
                    #print("null text embedding:",Nullprompt_embeds[0,0,:])
                    #import sys
                    #sys.exit()
                    reflatents = self.prepare_pil2latent(self.refimg_f,
                    ...
                    reflatent_model_input = torch.cat([reflatents] * 2) if do_classifier_free_guidance else reflatents
                ...
                refnoise_pred,skip_stack = self.unet(
                    latent_model_input,
